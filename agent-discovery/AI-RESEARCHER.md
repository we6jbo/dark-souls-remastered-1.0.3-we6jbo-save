...
Generated/updated: 2026-08-22T08:26:04.235987-07:00
...
## AI-Researcher task formats

Level 1 detailed idea:
Design and experimentally validate a reproducible architecture for a
human-directed, AI-assisted desktop simulator that evolves across two Linux
machines using versioned state, safe Git publication, Syncthing delivery,
authenticated peer reports, and local-first AI diagnostics.

Level 2 reference-based ideation:
Use this repository and its agent-discovery documents as the reference
material. Generate a novel, testable software-reliability or human/AI
collaboration idea, implement the idea in a sandbox, validate it, critique the
result, and document what would or would not transfer back to the live project.

Do not require or reconstruct privacy-tokenized values.
